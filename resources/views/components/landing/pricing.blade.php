...
<section id="pricing" class="nh-section" data-pricing-widget>
        ...
        <div class="grid grid-cols-1 gap-5 md:grid-cols-3">
            @foreach(collect($plans)->values() as $index => $plan)
                @php
                    ...
                    $cta = (string) data_get($plan, 'cta', ($key === 'enterprise' ? 'Contact Sales' : 'Get Started'));
                    $href = $key === 'enterprise'
                ...
                <article
                    ...
                    <div class="flex flex-1 flex-col">
                        <p class="text-sm font-semibold uppercase tracking-wide text-slate-500 dark:text-slate-300">
