...
<div class="app-card glow-strong p-5 sm:p-6" data-glow-proximity="132">
    ...
    <div class="app-subcard glow-subcard my-6 overflow-hidden bg-gray-50 px-4 py-6 dark:bg-gray-900 sm:px-6" data-glow-card data-glow-proximity="90">
