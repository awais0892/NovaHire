                ...
                <div class="space-y-6">
                    <div class="space-y-3">
                        <h1 class="auth-animate auth-delay-200 text-4xl font-semibold leading-tight tracking-tight text-slate-900 dark:text-white md:text-5xl">
                            <span class="font-light">Create your</span> account
                        </h1>
                        <p class="auth-animate auth-delay-300 text-base text-slate-500 dark:text-slate-300">
                            Join NovaHire and start with a signup flow that matches the login experience.
                        </p>
                    </div>

                    <div class="auth-animate auth-delay-400 rounded-2xl bg-slate-100 p-4 dark:bg-white/5">
                        <p class="text-sm font-semibold text-slate-900 dark:text-white">Candidate account</p>
                        <p class="mt-1 text-sm text-slate-500 dark:text-slate-300">
                            Self-registration is limited to candidates. Recruiter and other team profiles should be provisioned internally.
                        </p>
                    </div>
                    ...
                    <form wire:submit.prevent="register" class="space-y-5">
                        ...
                        <button type="submit" class="auth-animate auth-delay-1000 w-full rounded-2xl bg-brand-500 py-4 font-medium text-white transition hover:bg-brand-600 disabled:opacity-50">
                    ...
                    <a
                        ...
                        @class([
                            'auth-animate auth-delay-1000 flex w-full items-center justify-center gap-3 rounded-2xl border py-4 text-sm font-medium transition',
                            'border-slate-200 bg-slate-50 text-slate-700 hover:bg-slate-100 dark:border-white/10 dark:bg-white/5 dark:text-white dark:hover:bg-white/10',
                        ])>
