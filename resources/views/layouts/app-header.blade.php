<header
    class="sticky top-0 z-40 flex w-full bg-white border-gray-200 dark:border-gray-800 dark:bg-gray-900 xl:border-b"
    x-data="{
    ...
    <div class="flex flex-col items-center justify-between grow xl:flex-row xl:px-6">
        <div
            ...
            <a href="/" class="xl:hidden">
                <img class="dark:hidden h-8 w-auto object-contain" src="/images/logo/novahire-wordmark.svg"
                    alt="NovaHire Logo" />
                <img class="hidden dark:block h-8 w-auto object-contain" src="/images/logo/novahire-wordmark-light.svg"
                    alt="NovaHire Logo" />
            </a>
