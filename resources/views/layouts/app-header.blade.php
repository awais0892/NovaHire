    ...
    <div class="flex flex-col items-center justify-between grow xl:flex-row xl:px-6">
        <div
            ...
            <a href="/" class="xl:hidden">
                <img class="dark:hidden h-8 w-auto object-contain" src="/images/logo/novahire-logo.png"
                    alt="NovaHire Logo" />
                <img class="hidden dark:block h-8 w-auto object-contain" src="/images/logo/novahire-logo.png"
                    alt="NovaHire Logo" />
            </a>
